...
export default function SignupBetaNotice() {
      ...
      <div className="max-w-xl w-full bg-[#081028] border border-blue-500/30 rounded-3xl p-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-300 mb-6">
            iLinq.Team is currently operating in a public beta environment.
            Features, subscriptions, integrations and services may be modified,
            interrupted or removed without notice during the testing phase.
          </p>
